 ...
 */
public class SerializationTaskConfirmationDaoTest extends TaskConfirmationDaoTest {

    private static final String ROOT = "BinDatabaseRoot_TaskConfirmationDaoTest";
